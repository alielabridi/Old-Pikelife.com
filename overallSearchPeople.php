            ...
            $(document).ready(function(){
                ...
                $('#participants_view').bind('scroll', function(){
                   if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
                        participants_load++;
                        $.post("overallPeopleInfiniteScroll.php",{participants_load:participants_load, search_query:search_query},function(data){
...
<div class="related_posts white_box">
    <a id="Participants"><h3 class="rp_title">Search results of people having in their name '<?php echo $search_query; ?>'</h3></a>
