                ...
                <div class="inner">
                    ...
                    <div class="post_single_inner">
                        ...
                        <?php
                            ...
                            $Error = "";
                            $usr_fname = $usr_lname = $usr_email = $Location = "";
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $usr_lname = test_input($_POST["usr_lname"]);
                            $usr_fname = test_input($_POST["usr_fname"]);
                            $usr_email = test_input($_POST["usr_email"]);
                            ...
                            {
                                $_FILES["file"]["name"] = $sessionUser . '.' . $extension;
                                ...
                                header( "Location: /userProfile.php?user_id=$sessionUser") ;
                        }
                    ?>

                    <div class="post_entry" style="text-align: center">
                        <h1 style="color:#C53434; font-weight:bold;">Edit Profile</h1>
                        <p><span style="color:#C53434;"><?php echo $Error;?><span></span><br>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?user_id=<?php print_r($user_id); ?>" method="post"
                            enctype="multipart/form-data">
                               
                                <input type="text" name="usr_lname" placeholder="your last name" value="<?php echo $usr_lname;?>"><br><br>
                                <input type="text" name="usr_fname" placeholder="Your first name" value="<?php echo $usr_fname ?>"><br><br>
                                <input type="text" name="usr_email" placeholder="your email" value="<?php echo $usr_email;?>"><br><br>
                                <input type="text" name="location" placeholder="Your Location" value="<?php echo $location ?>"><br><br>
                                <label>select picture of your profile<br>Your picture should not exceed 10Mb</label>
